...
- 自建 : <https://ghproxy.161122.xyz/>或<https://gh.161122.xyz/>
...
:::
docker镜像已添加自建代理
如果无法拉取镜像请修改`docker-compose`中的`hub.021212.xyz/mlikiowa/napcat-docker:latest`
修改为`mlikiowa/napcat-docker:latest`或者添加你的代理
